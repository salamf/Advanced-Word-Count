...
//Amanda
#define UNITY_TEST_ASSERT_EQUAL_LONG_STRING(expected, actual, line, message)                          UnityAssertEqualLongString((const char*)(expected), (const char*)(actual), (message), (UNITY_LINE_TYPE)line)
