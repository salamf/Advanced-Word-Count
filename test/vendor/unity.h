...
//Amanda
#define TEST_ASSERT_EQUAL_LONG_STRING(expected, actual)                                                 UNITY_TEST_ASSERT_EQUAL_LONG_STRING(expected, actual, __LINE__, NULL)
...
//AMANDA
#define TEST_ASSERT_EQUAL_LONG_STRING_MESSAGE(expected, actual, message)                                UNITY_TEST_ASSERT_EQUAL_LONG_STRING(expected, actual, __LINE__, message)
